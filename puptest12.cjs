...
(async () => {
  ...
  await page.goto('http://localhost:5250/', { waitUntil: 'domcontentloaded', timeout: 15000 });
  ...
  console.log('=== BUY TAB (default, no-signup flow) ===');
  console.log(await page.evaluate(() => document.body.innerText));

  await clickByText('Покупка в один тап');
  await new Promise(r => setTimeout(r, 400));
  console.log('=== ADVANCED SECTION EXPANDED ===');
  console.log(await page.evaluate(() => document.body.innerText));
